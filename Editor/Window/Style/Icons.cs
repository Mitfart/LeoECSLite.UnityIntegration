namespace LeoECSLite.UnityIntegration.Editor.Window.Style {
  public static class Icons {
    ...
    */
    ...
    public static string TextPlus      => "✚";
    public static string TextReload    => "↻";
    public static string TextClose     => "✕";
    public static string TextArrowUp   => "▲";
    public static string TextArrowDown => "▼";
  }
}