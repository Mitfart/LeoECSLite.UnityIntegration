...
namespace LeoECSLite.UnityIntegration {
  public static class ActiveDebugSystems {
    ...
    public static bool TryGet(string worldName, out EcsWorldDebugSystem system) {
      return _SystemByNames.TryGetValue(worldName.ToWorldDebugName(), out system);
    }

    public static bool TryGet(EcsWorld world, out EcsWorldDebugSystem system) {
      return _SystemByWorlds.TryGetValue(world, out system);
    }
